...
public class CharacterFinder {
  ...
  public static void main(String[] args) {
    ...
    GAFinder<Character> finder = new GAFinder<Character>() {
      // this must be compatible with target of FF
      private targetLength = 260;
      ...
      protected FitnessFunction<Character> createFitnessFunction() {
        FitnessFunction<Character> fitness = new FitnessFunction<Character>(){
          private String target =          
           "A long string, to test how long a string can become, before it " +
           "really takes too many iterations to find an optimal solution. "  +
           "So far, it feels acceptable, but how far can I push this? The "  +
           "string/bytecode for a VM that can drive a robot will probably "  + 
           "be longer?";
